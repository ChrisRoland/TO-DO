...
import { CheckSquare, Eye, EyeOff, Mail, Lock, User, Chrome } from 'lucide-react'
...
export default function Register() {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      const { data, error } = await signUp(value.email, value.password, value.fullName)
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="space-y-1 pb-6">
              <CardTitle className="text-center text-xl">Get started for free</CardTitle>
            </CardHeader>
