    ...
    <header class="relative z-10 px-6 py-4">
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          <RouterLink to="/login">
            <Button variant="ghost" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
              Sign In
            </Button>
          </RouterLink>
      ...
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
          ...
          <div class="flex items-center justify-center space-x-4">
            ...
            <RouterLink to="/login">
              <Button size="lg" variant="outline" class="px-8 py-3 text-lg">
                Sign In
              </Button>
            </RouterLink>
          </div>
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-300 text-sm">Set priorities and focus on what matters most</p>
              </div>
            </div>
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-300 text-sm">Quick access to your high-priority items</p>
              </div>
            </div>
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-300 text-sm">Keep completed tasks organized and accessible</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="text-center">
          ...
          <RouterLink to="/register">
            <Button size="lg" class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-12 py-4 text-lg">
